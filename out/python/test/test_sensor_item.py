...
class TestSensorItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SensorItem:
        """Test SensorItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SensorItem`
        """
        model = SensorItem()
        if include_optional:
            return SensorItem(
                ...
                units = '',
                variablename = '',
                statistics = openapi_client.models.sensor_statistics.SensorStatistics(
                    max_value = 1.337, 
                    min_value = 1.337, 
                    avg_value = 1.337, 
                    stddev_value = 1.337, 
