        ...
        if include_optional:
            return GetCampaignResponse(
                ...
                location = openapi_client.models.location.Location(
                    ...
                    bbox_south = 1.337, 
                    bbox_north = 1.337, ),
                summary = openapi_client.models.summary_get_campaign.SummaryGetCampaign(
                    station_count = 56, 
                    sensor_count = 56, 
                    sensor_types = [
                        ''
                ...
                geometry = None,
                stations = [
                    openapi_client.models.stations_list_response_item.StationsListResponseItem(
                        id = 56, 
                        name = '', 
                        description = '', 
                        contact_name = '', 
                        ...
                        geometry = null, 
                        sensors = [
                            openapi_client.models.sensor_summary_for_stations.SensorSummaryForStations(
                                id = 56, 
                                variable_name = '', 
                                measurement_unit = '', )
                            ], )
