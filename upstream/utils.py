...
class ConfigManager:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.base_url = base_url or os.getenv("UPSTREAM_BASE_URL", "https://upstream-dso.tacc.utexas.edu/dev")
        self.ckan_url = ckan_url or os.getenv("CKAN_URL", "https://ckan.tacc.utexas.edu")
    ...
    def from_file(cls, config_path: Union[str, Path]) -> "ConfigManager":
        ...
        try:
            ...
            if "upload" in config_data:
                ...
                flattened_config["max_chunk_size_mb"] = upload_config.get("max_file_size_mb", 50)
...
def retry_with_backoff(
    ...
    for attempt in range(max_retries + 1):
        try:
            ...
            logger.warning(f"Attempt {attempt + 1} failed: {e}. Retrying in {total_delay:.2f} seconds...")
